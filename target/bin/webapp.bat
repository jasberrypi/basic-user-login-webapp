...
set CLASSPATH="%BASEDIR%"\etc;"%REPO%"\javax\servlet\javax.servlet-api\3.1.0\javax.servlet-api-3.1.0.jar;"%REPO%"\javax\servlet\jstl\1.2\jstl-1.2.jar;"%REPO%"\org\apache\tomcat\embed\tomcat-embed-core\8.5.2\tomcat-embed-core-8.5.2.jar;"%REPO%"\org\apache\tomcat\embed\tomcat-embed-logging-juli\8.5.2\tomcat-embed-logging-juli-8.5.2.jar;"%REPO%"\org\apache\tomcat\tomcat-jasper\8.5.2\tomcat-jasper-8.5.2.jar;"%REPO%"\org\apache\tomcat\tomcat-servlet-api\8.5.2\tomcat-servlet-api-8.5.2.jar;"%REPO%"\org\apache\tomcat\tomcat-juli\8.5.2\tomcat-juli-8.5.2.jar;"%REPO%"\org\apache\tomcat\tomcat-el-api\8.5.2\tomcat-el-api-8.5.2.jar;"%REPO%"\org\eclipse\jdt\core\compiler\ecj\4.5.1\ecj-4.5.1.jar;"%REPO%"\org\apache\tomcat\tomcat-api\8.5.2\tomcat-api-8.5.2.jar;"%REPO%"\org\apache\tomcat\tomcat-util-scan\8.5.2\tomcat-util-scan-8.5.2.jar;"%REPO%"\org\apache\tomcat\tomcat-util\8.5.2\tomcat-util-8.5.2.jar;"%REPO%"\org\apache\tomcat\tomcat-jasper-el\8.5.2\tomcat-jasper-el-8.5.2.jar;"%REPO%"\org\apache\tomcat\tomcat-jsp-api\8.5.2\tomcat-jsp-api-8.5.2.jar;"%REPO%"\commons-lang\commons-lang\2.6\commons-lang-2.6.jar;"%REPO%"\mysql\mysql-connector-java\8.0.16\mysql-connector-java-8.0.16.jar;"%REPO%"\com\google\protobuf\protobuf-java\3.6.1\protobuf-java-3.6.1.jar;"%REPO%"\io\muic\ooc\webapp\login-webapp\1.0-SNAPSHOT\login-webapp-1.0-SNAPSHOT.jar
